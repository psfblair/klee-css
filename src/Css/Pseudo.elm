...
-- 6.6.1.1 link pseudo-classes
link            = ":link"           |> Selector.filterFromString -- CSS level 1
visited         = ":visited"        |> Selector.filterFromString -- CSS level 1

-- 6.6.1.2 user action pseudo-classes
hover           = ":hover"          |> Selector.filterFromString -- CSS level 2
active          = ":active"         |> Selector.filterFromString -- CSS level 1
focus           = ":focus"          |> Selector.filterFromString -- CSS level 2

-- 6.6.2 target pseudo-class
target          = ":target"         |> Selector.filterFromString -- CSS level 3

-- 6.6.3 language pseudo-class
lang          n = Combinators.func "lang" [n]                    -- CSS level 2

-- 6.6.4 UI element states pseudo-classes
enabled         = ":enabled"        |> Selector.filterFromString -- CSS level 3
disabled        = ":disabled"       |> Selector.filterFromString -- CSS level 3
checked         = ":checked"        |> Selector.filterFromString -- CSS level 3
indeterminate   = ":indeterminate"  |> Selector.filterFromString -- CSS level 3

-- 6.6.5 Structural pseudo-classes
root            = ":root"           |> Selector.filterFromString -- CSS level 3
nthChild      n = Combinators.func "nth-child"        [n]        -- CSS level 3
nthLastChild  n = Combinators.func "nth-last-child"   [n]        -- CSS level 3
nthOfType     n = Combinators.func "nth-of-type"      [n]        -- CSS level 3
nthLastOfType n = Combinators.func "nth-last-of-type" [n]        -- CSS level 3
firstChild      = ":first-child"    |> Selector.filterFromString -- CSS level 2
lastChild       = ":last-child"     |> Selector.filterFromString -- CSS level 3
firstOfType     = ":first-of-type"  |> Selector.filterFromString -- CSS level 3
lastOfType      = ":last-of-type"   |> Selector.filterFromString -- CSS level 3
onlyChild       = ":only-child"     |> Selector.filterFromString -- CSS level 3
onlyOfType      = ":only-of-type"   |> Selector.filterFromString -- CSS level 3
empty           = ":empty"          |> Selector.filterFromString -- CSS level 3
-- TODO not(x) takes a simple selector (excluding the negation pseudo-class itself)
notPs         n = Combinators.func "nth-last-of-type" [n]        -- CSS level 3

-- For the following, see https://developer.mozilla.org/en-US/docs/Web/CSS/Pseudo-classes
default_        = ":default"        |> Selector.filterFromString -- CSS basic UI Module level 3
valid           = ":valid"          |> Selector.filterFromString -- CSS basic UI Module level 3
invalid         = ":invalid"        |> Selector.filterFromString -- CSS basic UI Module level 3
inRange         = ":in-range"       |> Selector.filterFromString -- CSS basic UI Module level 3
outOfRange      = ":out-of-range"   |> Selector.filterFromString -- CSS basic UI Module level 3
required        = ":required"       |> Selector.filterFromString -- CSS basic UI Module level 3
optional        = ":optional"       |> Selector.filterFromString -- CSS basic UI Module level 3
readOnly        = ":read-only"      |> Selector.filterFromString -- CSS basic UI Module level 3
readWrite       = ":read-write"     |> Selector.filterFromString -- CSS basic UI Module level 3

dir           n = Combinators.func ":dir" [n]                    -- HTML5
fullscreen      = ":fullscreen"     |> Selector.filterFromString -- Fullscreen API
-------------------------------------------------------------------------------
...
-- table-cell.
firstLine       = "::first-line"    |> Selector.filterFromString -- CSS level 1 (with one colon)
firstLetter     = "::first-letter"  |> Selector.filterFromString -- CSS level 1 (with one colon)

after           = "::after"         |> Selector.filterFromString -- CSS level 2 (with one colon)
before          = "::before"        |> Selector.filterFromString -- CSS level 2 (with one colon)

selection       = "::selection"     |> Selector.filterFromString -- CSS Pseudo-Elements Level 4 (working draft)
backdrop        = "::backdrop"      |> Selector.filterFromString -- Fullscreen API
